...
export interface Stream<VALUE, NAME extends NonEmptyString = "root"> {
...
export namespace Stream {
  export function create<VALUE, NAME extends NonEmptyString = "root">(options?: Options<VALUE, NAME>) {
    const stream = {};
