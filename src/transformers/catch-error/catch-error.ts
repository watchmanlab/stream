...
> extends Stream<
  ...
  | Stream.MaybeSourceErr<
      SOURCE_ERR,
      ERROR,
      Stream.Traversable<CatchError<INPUT_STREAM, SOURCE_ERR, ERROR, NAME>, INPUT_STREAM>
    >,
  NAME
> {
  protected _caught?: Stream<SOURCE_ERR, `${NAME}Caught`>;
  constructor(name: NAME, inputStream: INPUT_STREAM, callback?: catchError.Callback<SOURCE_ERR, ERROR>) {
...
>(): Stream.Transform<
  INPUT_STREAM,
  Stream.Traversable<CatchError<INPUT_STREAM, SOURCE_ERR, ERROR, catchError.Name>, INPUT_STREAM>
>;
export function catchError<
  NAME extends string,
  INPUT_STREAM extends Stream.AnyStream,
...
>(
  name: NAME,
): Stream.Transform<INPUT_STREAM, Stream.Traversable<CatchError<INPUT_STREAM, SOURCE_ERR, ERROR, NAME>, INPUT_STREAM>>;
export function catchError<
  NAME extends string,
  INPUT_STREAM extends Stream.AnyStream,
  SOURCE_ERR extends Stream.AnySourceErr = Stream.ExtractSourceErr<INPUT_STREAM>,
...
export function catchError<
  ...
  NAME extends string = catchError.Name,
>(
  nameOrCallback?: NAME | catchError.Callback<SOURCE_ERR, ERROR>,
  callback?: catchError.Callback<SOURCE_ERR, ERROR>,
): Stream.Transform<INPUT_STREAM, Stream.Traversable<CatchError<INPUT_STREAM, SOURCE_ERR, ERROR, NAME>, INPUT_STREAM>> {
  return (inputStream) =>
    Stream.traversable(
