...
export class Stream<VALUE, NAME extends string = Stream.Name> implements AsyncIterable<VALUE>, Disposable {
  ...
  listen(fn: Stream.Consumer.Fn<VALUE>, abortSignal?: Stream.AnyStream): Stream.Consumer<VALUE> {
  ...
  listenOnce(fn: Stream.Consumer.Fn<VALUE>): Stream.Consumer<VALUE> {
